					...
					<aside class="front_aside">
						<div class="aside_wrapper">
							<div class="front_aside_about front-card shadow">
								<h3 class="front_aside_about__head front-head">About Me</h3>
								<div class="front_aside_about__image">
									<img class="image-cov" src="./assets/image/about-image.jpg" alt="">
								</div>
								<div class="front_aside_about__text">Lorem ipsum dolor sit amet, consectetur adipiscing
									elit.
									Cum in
									vel
									massa donec sit. Mi ut risus sem malesuada ornare.
									Ac eu erat eget et lorem est arcu. Gravida hendrerit sit blandit semper lacus. Nulla
									amet
									suscipit
									sit lectus tortor.
									Dolor non eget suspendisse leo scelerisque sed d.</div>
						...
						<div class="aside_wrapper">
							<div class="front_aside_categories front-card shadow">
								...
								<div class="front_aside_categories_content">
									<div>
										<div class="front_aside_categories_content__name">Europe</div>
										<div class="front_aside_categories_content__quantity">(11)</div>
									</div>
									<div>
										<div class="front_aside_categories_content__name">Europe</div>
										<div class="front_aside_categories_content__quantity">(11)</div>
